...
const adminNav: NavItem = { href: '/dashboard/admin', label: 'Painel Admin', icon: Shield, managerOnly: true }
  ...
  return (
    <div className="flex h-screen bg-slate-100 overflow-hidden">
      <aside className="w-16 lg:w-60 bg-slate-900 flex flex-col py-4 shrink-0">
        ...
        {/* Rodapé: Painel Admin (se gestor) + usuário + sair */}
        <div className="px-2 space-y-1 border-t border-slate-800 pt-3 mt-2">
          {isManager && <NavLink {...adminNav} />}

          <div className="hidden lg:flex items-center gap-2 px-3 py-2 mt-1">
